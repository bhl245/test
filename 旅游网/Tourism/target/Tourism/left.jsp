        ...
        <td width="182" valign="top">
            <div id="container">
                ...
                <div class="content">
                    ...
                    <ul class="MM">
                        <li><a href="lineAdd.jsp" target="main">添加线路</a></li>
                        <li><a href="allLine.action" target="main">查看线路</a></li>
                    </ul>
                </div>

                <h1 class="type"><a href="javascript:void(0)">旅游线路类型管理</a></h1>
                <div class="content">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="ht/images/menu_topline.gif" width="182" height="5"/></td>
                    ...
                    <ul class="MM">
                        <li><a href="lineTypeAdd.jsp" target="main">添加线路类型</a></li>
                        <li><a href="allLineType.action" target="main">查看线路类型</a></li>
                    </ul>
                </div>

                <h1 class="type"><a href="javascript:void(0)">旅游团购管理</a></h1>
                <div class="content">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="ht/images/menu_topline.gif" width="182" height="5"/></td>
                    ...
                    <ul class="MM">
                        <li><a href="allGroup.action" target="main">查看团购信息</a></li>
                    </ul>
                </div>
            </div>
