...
<div id="content1">
    ...
    <div id="con1-right">
        <div id="right-top">
            ...
            <div class="zcdl">
                <ul>
                    <li style="margin-right:3px;"><a href="login.jsp"><img src="qt/images/dl.jpg" width="85" height="36"/></a>
                    </li>
                    <li><a href="regist.jsp"><img src="qt/images/zc.jpg" width="85" height="36"/></a></li>
                </ul>
            </div>
            <div class="my">
                <ul>
