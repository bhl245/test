    		...
    		if(add_ivtname.length==0||add_ivtsex.length==0||
    			...
    			alert("请完善信息！");
 				...
 				$.ajax({
    				...
    				data:{"invitejob.ivt_name":add_ivtname,"invitejob.ivt_sex":add_ivtsex,
   	...
   	<div id="father">
   		...
   		<div id="center2" align="center">
   			<form id="addform">
	   			...
	   			<tr>
	   				<th>姓名：</th>
	   				<td><input type="text" name="add_ivtname" id="add_ivtname"></td>
	   				<th>性别：</th>
	   				<td>
	   				<input type="radio" name="add_ivtsex" id="add_ivtmale" value="男" checked="checked"><label for="add_ivtmale">男</label>
    				<input type="radio" name="add_ivtsex" id="add_ivtfamale" value="女"><label for="add_ivtfamale">女</label>
    				</td>
	   			</tr>
	   			<tr>
	   				<th>年龄：</th>
	   				<td><input type="text" name="add_ivtage" id="add_ivtage"></td>
	   				<th>出生日期：</th>
	   				<td><input type="text" name="add_ivtborn" id="add_ivtborn"></td>
	   			</tr>
	   			<tr>
	   				<th>应聘职位：</th>
	   				<td><input type="text" name="add_ivtjob" id="add_ivtjob"></td>
	   				<th>所学专业：</th>
	   				<td><input type="text" name="add_ivtspecialty" id="add_ivtspecialty"></td>
	   			</tr>
	   			<tr>
	   				<th>工作经验：</th>
	   				<td><input type="text" name="add_ivtexperience" id="add_ivtexperience" value="无"></td>
	   				<th>文化程度：</th>
	   				<td>
						<select name="add_ivtteachSchool" id="add_ivtteachSchool" style="width: 150px;">
	   			...
	   			<tr>
	   				<th>联系电话：</th>
	   				<td><input type="text" name="add_ivttel" id="add_ivttel"></td>
	   				<th>毕业学校：</th>
	   				<td><input type="text" name="add_ivtafterSchool" id="add_ivtafterSchool"></td>
	   			</tr>
	   			<tr>
	   				<th>家庭住址：</th>
	   				<td><input type="text" name="add_ivtaddress" id="add_ivtaddress"></td>
	   				<th>登记时间：</th>
	   				<td><input type="text" name="add_ivtcreatetime" id="add_ivtcreatetime" value="${systime }" disabled="disabled"></td>
	   			</tr>
	   			<tr>
	   				<th>个人简介：</th>
	   				<td colspan="3">
	   					<textarea rows="6" cols="55" name="add_ivtcontent" id="add_ivtcontent">应届毕业生，无工作经验</textarea>
	   				</td>
	   			</tr>
	   			</table>
	   			<br>
	   			<input type="button" value="保存" onclick="ivtaddck()">&nbsp;&nbsp;
