...
<head>
    ...
    <script type="text/javascript">
        ...
        //             url: "tnAddAjax!addTn",
        //             data: {
        //                 "train.tn_man": add_tnman, "train.tn_title": add_tntitle,
...
<div id="father">
    ...
    <div id="center2" align="center">
        <form id="addform" action="../TrainServlet?action=insert" method="post">
            <!-- /培训添加表单以及按钮/ -->
            <table id="ctr2tnadd" border="1" cellpadding="0" cellspacing="0">
                <tr>
                    <th>培训人：</th>
                    <td><input type="text" name="tPerson" id="tPerson" style="width: 250px;"></td>
                </tr>
                <tr>
                    <th>培训主题：</th>
                    <td><input type="text" name="tTheme" id="tTheme" style="width: 250px;"></td>
                </tr>
                <tr>
                    <th>培训宗旨：</th>
                    <td><input type="text" name="tPurpose" id="tPurpose" style="width: 250px;"></td>
                </tr>
                <tr>
                    <th>培训时间：</th>
                    <td><input type="text" name="tTime" id="tTime" style="width: 250px;" value="${date}"></td>
                </tr>
                <tr>
                    <th>培训地点：</th>
                    <td><input type="text" name="tPlace" id="tPlace" style="width: 250px;"></td>
                </tr>
                <tr>
                    <th>参加人员：</th>
                    <td><input type="text" name="tParticipant" id="tParticipant" style="width: 250px;"></td>
                </tr>
                <tr>
                    <th>备注信息：</th>
                    <td>
                        <textarea rows="10" cols="32" name="tDesp" id="tDesp"></textarea>
                    </td>
                </tr>
            </table>
            <br>
