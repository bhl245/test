...
<div id="father">
    ...
    <div id="center2" align="center">
        ...
        <table id="ctr2dptsel" border="1" cellpadding="0" cellspacing="0">
            ...
            <c:forEach items="${sessionScope.departmentList }" var="dptl">
                <tr>
                    <td>${dptl.dId }</td>
                    <td>${dptl.dName }</td>
                    <td>${dptl.dTime }</td>
                    ...
                    <td>${dptl.dDesp }</td>
                    <td>
                        <a href="../DepartmentServlet?action=delete&dId=${dptl.dId }" onclick="isdel('${dptl.dName }')">删除</a>
        ...
        <!-- /分页的按钮/ -->
        <div id="fenye">
            <a href="../DepartmentServlet?action=all&pageIndex=1">首页</a>
            <a href="../DepartmentServlet?action=all&pageIndex=${pageIndex-1}">上一页</a>
            ${pageIndex}/${totalPage}
            <a href="../DepartmentServlet?action=all&pageIndex=${pageIndex+1}">下一页</a>
            <a href="../DepartmentServlet?action=all&pageIndex=${totalPage}">尾页</a><br><br>
