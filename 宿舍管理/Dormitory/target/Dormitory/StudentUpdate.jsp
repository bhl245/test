                            ...
                            <table width="709" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                                        <form name="form1" method="post" action="/updateStudent.form"
                                              onSubmit="return mycheck()">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="33%" height="30" align="right">&nbsp;</td>
                                                    <td width="67%"><input name="studentId" type="hidden" class="noshow"
                                                                           id="Student_ID" value="${student.studentId}"></td>
                                                </tr>
                                                <tr>
                                                    <td height="30" align="right"><span style="color:red;">*</span>用户名：</td>
                                                    <td><input name="studentUsername" type="text" class="text2"
                                                               id="Student_Username" value="${student.studentUsername}"></td>
                                                </tr>
                                                <tr>
                                                    <td height="30" align="right">密码：</td>
                                                    <td><input name="studentPassword" type="password" class="text2"
                                                               id="Student_Password" value="${student.studentPassword}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><select name="studentSex" id="Student_Sex">
                                                        ...
                                                        <option value="男"
                                                                <c:if test="${student.studentSex eq '男'}">selected="selected"</c:if>>
                                                            男
                                                        </option>
                                                        <option value="女"
                                                                <c:if test="${student.studentSex eq '女'}">selected="selected"</c:if>>
                                                            女
                                                        </option>
                                                    </select></td>
                                                </tr>
