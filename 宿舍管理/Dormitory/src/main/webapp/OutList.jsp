                                ...
                                <tr>
                                    <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <c:forEach items="${out1List}" var="out">
                                                <tr align="center">
                                                    <td height="25" align="center">${out.outDate}</td>
                                                    <td>${out.student.studentName}</td>
                                                    <td>${out.student.studentSex}</td>
                                                    <td>${out.student.studentClass}</td>
                                                    <td>${out.outRemark}</td>
                                                </tr>
                                            </c:forEach>
                                        </table>
