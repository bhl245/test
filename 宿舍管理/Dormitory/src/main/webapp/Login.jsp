                ...
                <table width="350" height="201" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="center" valign="top">
                            <form name="form1" action="/loginAction.form" method="post" onSubmit="return mycheck()">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td height="30" colspan="2" align="center">${message}</td>
                                    </tr>
                                    <tr>
                                        <td height="30" colspan="2" align="center">
                                            <label><input type="submit" name="button" id="button" value="登录"></label>
                                        </td>
                                    </tr>
                                </table>
                            </form>
